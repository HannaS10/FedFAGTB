...
class FAGTB(object):
    ...
    def fit(self, X, y, sensitive, LAMBDA, Xtest, yt, sensitivet):
        ...
        for i in range(self.n_estimators):
            ...
            #if i % 5 == 0:
            print(i, np.sum(lfadv), np.sum(losstraining), np.sum(lossglobal), "Accuracy:", round(accuracy, 8),
...
# Example usage with 'sepal length (cm)' as sensitive attribute and 'target' as the target variable
