...
class FAGTB(object):
    ...
    def fit_adversial(self, X, y, sensitive, LAMBDA, Xtest, yt, sensitivet, y_pred): #y_pred2, y_pred, y_predt
        y2 = np.expand_dims(sensitive, axis=1)
        if i == 0:
            lfadv = 0
        graph = tf.Graph()
        ...
        return {'S_ADV': S_ADV, 'lfadv': lfadv} #'gradient_adv': gradient_adv
...
print('#####################################################################')
# initialization
result_initialization = classifier.fit_initial(X_train.values, y_train.values, sensitive, LAMBDA=0.15,
                                               Xtest=X_test.values, yt=y_test, sensitivet=sensitivet)
print('initialization')
y_pred2_from_initialization = result_initialization['y_pred2']
y_pred_from_initialization = result_initialization['y_pred']
y_predt_from_initialization = result_initialization['y_predt']
...
for i in range(n_estimators):
    ...
    if i == 0:
        ...
        result_adversarial_i = classifier.fit_adversial(X_train.values, y_train.values, sensitive, LAMBDA=0.15,
                                                        Xtest=X_test.values, yt=y_test, sensitivet=sensitivet,
                                                        y_pred=y_pred_from_initialization) #y_pred2=y_pred2_from_initialization,
        # result_adversarial_list.append(result_adversarial_i)
        ...
        result_classifier_i = classifier.fit_classifier(X_train.values, y_train.values, sensitive, LAMBDA=0.15,
                                                        Xtest=X_test.values, yt=y_test, sensitivet=sensitivet,
                                                        y_pred=y_pred_from_initialization,
                                                        y_predt=y_predt_from_initialization,
        ...
        # Fit adversarial for i >= 1
        result_adversarial_i = classifier.fit_adversial(X_train.values, y_train.values, sensitive, LAMBDA=0.15,
                                                        Xtest=X_test.values, yt=y_test, sensitivet=sensitivet,
                                                        y_pred=aggregated_result) #y_pred2=aggregated_result
        ...
        result_classifier_i = classifier.fit_classifier(X_train.values, y_train.values, sensitive, LAMBDA=0.15,
                                                        Xtest=X_test.values, yt=y_test, sensitivet=sensitivet,
                                                        y_pred=aggregated_result,
                                                        y_predt=y_predt_from_classifier,
                                                        lfadv=gradient_adv_from_adversarial)
        # result_classifier_list.append(result_classifier_i)
        y_pred2_from_classifier = result_classifier_i['y_pred2'] #y_fin
        y_pred_from_classifier = result_classifier_i['y_pred']
        y_predt_from_classifier = result_classifier_i['y_predt']
